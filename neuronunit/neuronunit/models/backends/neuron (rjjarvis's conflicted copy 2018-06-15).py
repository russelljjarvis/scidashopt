...
class NEURONBackend(Backend):
    ...
    def init_backend(self, attrs = None, cell_name = None, current_src_name = None, DTC = None):
        ...
        if cell_name:
            print('got into interesting constructor \n\n\n\n\n')
        ...
        if type(DTC) is not type(None):
            ...
            if hasattr(DTC,'current_src_name'):
                print('got into DTC c s n  \n\n\n\n\n',DTC,DTC.current_src_name)
                self._current_src_name = DTC.current_src_name

                self.model.current_src_name = DTC.current_src_name

            if hasattr(DTC,'cell_name'):
                self.cell_name = DTC.current_src_name

                self.model.cell_name = DTC.cell_name
