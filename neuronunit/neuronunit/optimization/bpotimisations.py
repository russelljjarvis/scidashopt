...
class DEAPOptimisation(bluepyopt.optimisations.Optimisation):
    ...
    def setnparams(self, nparams=10, provided_keys=None):
        ...
        self.params = optimization_management.create_subset(nparams=nparams,provided_keys=provided_keys)
    ...
    def setup_deap(self):
        ...
        def custom_code(invalid_ind):
            ...
            return_package = list(update_deap_pop(invalid_ind, self.error_criterion, td = self.td))#, CPU_NUM=self.CPU_NUM))
